...
// ======================================================
// CHECK WHETHER TEXT IS MEANINGFUL
// ======================================================
...
function hasMeaningfulText(value) {
  ...
  /*
   * Very short entries are generally not enough to establish
  ...
  /*
   * Reject obvious repeated-character / placeholder-style text.
   * This is intentionally conservative and is NOT intended to
   * perform medical diagnosis or clinical validation.
   */
  ...
  /*
   * Reject common obvious placeholder / test entries.
   */
  const placeholderPattern =
    /^(test|testing|dummy|sample|asdf|qwer|qwerty|zxc|xxx|abc|abcd|random|none|na|n\/a)$/i;
...
// ======================================================
// DETERMINE WHETHER A MEDICAL RECORD IS CLINICALLY USABLE
// ======================================================
...
function isClinicallyUsableRecord(record) {
  ...
  /*
   * If an AI risk score exists, the record has already passed
   * the backend AI's minimum clinical-assessment requirements.
   */
  if (
    typeof record.ai_risk_score === "number" &&
    Number.isFinite(record.ai_risk_score)
  ) {
    return true;
  }

  /*
   * If the AI summary explicitly states that the record is
   * uninterpretable or insufficient, treat it as unusable.
   */
  const aiSummary =
    typeof record.ai_summary === "string"
      ? record.ai_summary.toLowerCase()
      : "";
  ...
  const invalidIndicators = [
    ...
    "incomplete data",
    "incomplete clinical",
    "clinical assessment is limited",
    "cannot be reliably assessed",
    "unable to assess",
  ];

  if (
    invalidIndicators.some((indicator) =>
      aiSummary.includes(indicator)
    )
  ) {
    return false;
  }
  ...
  /*
   * Count meaningful clinical text fields.
   */
  ...
  /*
   * A record with at least two meaningful clinical text sections
   * is considered usable for the frontend overview.
   */
  if (meaningfulTextFields.length >= 2) {
    return true;
  }
...
function MedicalHistoryCard({ record, onView }) {
  return (
    <div className="border rounded-2xl p-5 bg-white shadow-sm">
      ...
      {!isClinicallyUsableRecord(record) && (
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-amber-700 mt-1">
                This record contains insufficient or
                uninterpretable clinical information for a
...
function PatientDetailsModal({
  ...
  // ======================================================
  // LATEST RECORDED MEDICAL RECORD
  // ======================================================
  ...
  const latestClinicallyUsableRecord = useMemo(() => {
  ...
  // ======================================================
  // CHECK WHETHER LATEST RECORDED RECORD IS USABLE
  // ======================================================

  const latestRecordIsUsable = useMemo(() => {

    if (!latestRecord) {
      return false;
    }

    return isClinicallyUsableRecord(latestRecord);
  ...
  const healthStats = useMemo(() => {
    ...
    const latestRisk =
      latestClinicallyUsableRecord?.ai_risk_score;
    ...
    return {
      ...
      clinicallyUsableVisit:
        latestClinicallyUsableRecord?.visit_date ||
        null,
    };
    ...
    <>
      ...
      >
        ...
        <div className="border-t pt-8 mb-10">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-5">
            ...
            {latestClinicallyUsableRecord && (
              <span className="px-3 py-1 rounded-full bg-slate-100 text-slate-600 text-sm font-medium">
                Latest Clinically Usable Visit:{" "}
                {formatDate(
                  latestClinicallyUsableRecord.visit_date
                )}
              </span>
          ...
          {/* Latest Recorded Visit Warning */}

          {!historyLoading &&
            latestRecord &&
            !latestRecordIsUsable && (
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-amber-800">
                      Latest recorded visit requires documentation review
                    </p>

                    <p className="text-sm text-amber-700 mt-1 leading-relaxed">

                      The most recent recorded visit on{" "}
                      <strong>
                        {formatDate(
                          latestRecord.visit_date
                        )}
                      </strong>{" "}
                      does not contain sufficient meaningful
                      clinical documentation for a reliable
                      clinical assessment. It has therefore
                      been excluded from the clinically usable
                      health overview.
                    ...
                    {latestClinicallyUsableRecord && (
                      <p className="text-sm text-amber-700 mt-2">
                        ...
                        The overview below uses the latest
                        clinically usable visit from{" "}
                        <strong>
                          {formatDate(
                            latestClinicallyUsableRecord.visit_date
                          )}
          ...
          {historyLoading ? (
            ...
            <>
              ...
              {/* Latest Clinically Usable Vital Signs */}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-5">
                ...
                <HealthStatCard
                  ...
                  title="Temperature"
                  value={
                    latestClinicallyUsableRecord.temperature !==
                      null &&
                    latestClinicallyUsableRecord.temperature !==
                      undefined
                      ? latestClinicallyUsableRecord.temperature
                ...
                <HealthStatCard
                  ...
                  title="Heart Rate"
                  value={
                    latestClinicallyUsableRecord.heart_rate !==
                      null &&
                    latestClinicallyUsableRecord.heart_rate !==
                      undefined
                      ? latestClinicallyUsableRecord.heart_rate
                ...
                <HealthStatCard
                  ...
                  value={
                    latestClinicallyUsableRecord.oxygen_saturation !==
                      null &&
                    latestClinicallyUsableRecord.oxygen_saturation !==
                      undefined
                      ? latestClinicallyUsableRecord.oxygen_saturation
                ...
                <HealthStatCard
                  ...
                  value={
                    latestClinicallyUsableRecord.blood_pressure ||
                    "-"
                  }
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="rounded-2xl border bg-white p-5 shadow-sm">
                  ...
                  <p className="text-sm text-gray-500">
                    Most recent visit recorded in the system
                  </p>
              ...
              {/* Latest Clinically Usable Assessment */}
              ...
              <div className="mt-4 bg-blue-50 border border-blue-100 rounded-2xl p-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-slate-700 capitalize">
                      {latestClinicallyUsableRecord.visit_type
                        ? latestClinicallyUsableRecord.visit_type.replaceAll(
                            "_",
                            " "
                          )
                        : "Not recorded"}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
                  ...
                  <div>
                    ...
                    <p className="text-slate-700">
                      {latestClinicallyUsableRecord.chief_complaint ||
                        "Not recorded"}
                    </p>
                  ...
                  <div>
                    ...
                    <p className="text-slate-700">
                      {latestClinicallyUsableRecord.diagnosis ||
                        "Not recorded"}
                    </p>
            ...
            <div className="bg-slate-50 rounded-2xl p-8 text-center">
              ...
              <h4 className="font-semibold text-slate-700 mb-1">
                No Clinically Usable Health Data Available
              </h4>

              <p className="text-sm text-gray-500">
                Add a medical record containing meaningful
                clinical information to generate the patient's
                health overview.
              </p>
              ...
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className="bg-white border rounded-2xl p-5 shadow-sm">
                    ...
                    {longitudinalAnalysis.recurring_conditions?.length >
                    0 ? (
                  ...
                  <div className="bg-white border rounded-2xl p-5 shadow-sm">
                    ...
                    {longitudinalAnalysis.recurring_complaints?.length >
                    0 ? (
                ...
                <div className="bg-green-50 border border-green-100 rounded-2xl p-5">
                  ...
                  {longitudinalAnalysis.follow_up_recommendations?.length >
                  0 ? (
                ...
                <div className="space-y-6">
                  ...
                  {medicalRecords.map((record) => (
                    ...
                    >
                      ...
                      <div
                        className={`absolute left-2.5 top-5 w-5 h-5 rounded-full border-4 border-white shadow z-10 ${
                          isClinicallyUsableRecord(record)
                            ? "bg-blue-600"
                            : "bg-amber-500"
                        }`}
